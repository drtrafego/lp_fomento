      ...
      <Section dark>
        <div className="text-center space-y-8">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <img src={mapaOrgaos} alt="Mapa dos órgãos de fomento no Brasil" className="relative w-full rounded-2xl border border-[#d4a853]/15 shadow-xl" loading="lazy" decoding="async" <img src={mapaOrgaos} alt="Mapa dos órgãos de fomento no Brasil" className="relative w-full rounded-2xl border border-[#d4a853]/15 shadow-xl" loading="lazy" decoding="async" width={700} height={478} /> />
          </div>
