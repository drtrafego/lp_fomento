    ...
    <div ref={sectionRef} className="max-w-6xl mx-auto relative z-10">
      <div className="text-center mb-14 space-y-4">
        ...
        <div className="flex justify-center mt-6 mb-2">
          <div className="w-80 sm:w-full md:w-[650px] rounded-2xl overflow-hidden border border-[#d4a853]/15 shadow-[0_0_30px_rgba(212,168,83,0.12)]">
            <img
              src={pedroZoomInline}
...
export default function BelowFoldSections({ userEstado, userUf, handleCheckoutClick, autoridadeRef, ofertaRef }: BelowFoldProps) {
  ...
  return (
    <>
      ...
      <div data-section="ProvaSocial">
      <Section dark className="!pt-6 sm:!pt-16" id="resultados-reais">
