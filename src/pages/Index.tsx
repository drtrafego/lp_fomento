          ...
          return (
            ...
            >
              ...
              <div className="relative space-y-4 text-center">
                <div className="w-16 h-16 rounded-2xl bg-[#d4a853]/10 flex items-center justify-center mx-auto border border-[#d4a853]/20 overflow-hidden">
                  {b.customIcon === "lista-top" ? (
                    <img src={listaTopIcon} alt="Lista TOP 10" className="w-10 h-10 object-contain" />
                  ) : (
...
function PixNotificationsSection({ uf }: { uf: string | null }) {
  ...
  return (
    <div ref={containerRef} className="sm:hidden relative min-h-[200vh] pb-0 bg-[#0a1628]">
